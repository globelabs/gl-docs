...
If ever a subscribes chooses to opt-out or unsubscribe to your application. They will need to text in STOP to your shortcode. After stopping the subscription, a json data will be passed to your redirect_uri informing you that a subscriber had just unsubscribed to your service.
